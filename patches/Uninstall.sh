...
echo "Reverting LegacyCamera patches..."
...
echo "Reverting Gallery2 patches..."
...
echo "Reverting libncurses patches..."
...
cd $rootdirectory
cd frameworks/av
echo "Reverting frameworks/av patches..."
...
echo "Reverting hardware/qcom/display patches..."
